-- =====================================================
-- CORRECTION SIMPLIFIEE DU CRYPTAGE DES MOTS DE PASSE
-- =====================================================
-- Ce script corrige le problème de cryptage BCrypt sans erreurs

-- 1. SUPPRESSION SIMPLE DES COMPTES EXISTANTS
-- ===========================================

-- Supprimer directement les utilisateurs des tables de rôles
